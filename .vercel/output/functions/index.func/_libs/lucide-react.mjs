...
const BookPlus = createLucideIcon("book-plus", __iconNode$J);
const __iconNode$I = [
...
const FingerprintPattern = createLucideIcon("fingerprint-pattern", __iconNode$s);
const __iconNode$r = [
  [
    "path",
    {
...
const HandHelping = createLucideIcon("hand-helping", __iconNode$o);
const __iconNode$n = [
  [
    "path",
    {
...
const Tent = createLucideIcon("tent", __iconNode$9);
const __iconNode$8 = [
